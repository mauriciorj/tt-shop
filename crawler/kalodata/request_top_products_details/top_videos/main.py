...
from request_top_products_details.top_videos.request.main import main as request_api
from request_top_products_details.top_videos.request.dto import dto as request_api_dto
from request_top_products_details.top_videos.convex.main import main as update_db_convex

# def load_json():
#     current_dir = os.path.dirname(os.path.abspath(__file__))
#     file_path = os.path.join(current_dir, 'product-detail-video-queryList.json')
