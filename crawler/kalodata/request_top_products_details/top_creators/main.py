...
from request_top_products_details.top_creators.request.main import main as request_api
from request_top_products_details.top_creators.request.dto import dto as request_api_dto
from request_top_products_details.top_creators.convex.main import main as update_db_convex
from request_top_products_details.top_creators.postgres.main import main as update_db_postgres
...
def main(driver, product_k_id, type, page):
    # STEP 01 - Request the list of the top creators
    request_api_result = request_api(driver, product_k_id)
