...
def update_stores_db_convex(product_id, product_k_id, top_creators, top_videos, top_store_sales):
    print('')
    ...
    try:
        ...
        client.mutation("products:updateProductDetails", {'data': data_map})
