curl 'https://www.kalodata.com/product/queryList' \
  ...
  -H 'pragma: no-cache' \
  -H 'priority: u=1, i' \
  -H 'referer: https://www.kalodata.com/product' \
