...
from request_top_stores_details.top_videos.request.main import main as request_api
from request_top_stores_details.top_videos.request.dto import dto as request_api_dto
from request_top_stores_details.top_videos.convex.main import main as update_db_convex
from request_top_stores_details.top_videos.postgres.main import main as update_db_postgres
...
def main(driver, store_k_id, type, page): 
    ...
    save_json(data=request_api_result, file_name=f'request_top_videos_{page}.json')
