CREATE TABLE stores (
  ...
  main_category_id INTEGER, -- main_category from shop-detail
  second_category_id INTEGER, -- second_category from shop-detail
  third_category_id INTEGER, -- third_category from shop-detail
