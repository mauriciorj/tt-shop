...
def create_categories():
    ...
    try:
        ...
        sql_file_path = os.path.join(current, 'categories.sql')
        ...
        conn.commit()
        cursor.close()
        print("[ SELENIUM ] Table 'categories' created successfully.")
        
    except Exception as e:
        save_error(source='postgres_tables/create_categories', error=e)
