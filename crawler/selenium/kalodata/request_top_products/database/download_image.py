...
def download_image(product_id, k_id):
    try:
        print(f'[ SELENIUM ] Download Image Step 000')
        project_root = os.path.dirname(parent_parent_parent)
        print(f'[ SELENIUM ] Download Image Step 001')
        images_dir = os.path.join(project_root, 'public', 'images', 'products')
        print(f'[ SELENIUM ] Download Image Step 002')
        ...
        print(f'[ SELENIUM ] Download Image Step 003 {image_path}')
        ...
        print(f'[ SELENIUM ] Download Image Step 004 {response}')
        if response.status_code == 200:
            print(f'[ SELENIUM ] Download Image Step 005')
